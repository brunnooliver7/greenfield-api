...
public class MedicamentoController {
  ...
  public MedicamentoDTO save(@RequestBody @Valid MedicamentoDTO medicamentoDTO) {
  ...
  @PutMapping
  public MedicamentoDTO update(@RequestBody @Valid MedicamentoDTO medicamentoDTO) {
